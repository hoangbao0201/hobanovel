...
const ContentNovelDetail = ({ novel, handleUnfollowNovel, handleFollowNovel, isFollow }: ContentNovelDetailProps) => {
    ...
    return (
        <>
            ...
            <article className="mb-6 sm:flex">
                <div className="sm:w-3/12 w-full flex-shrink-0 max-sm:mb-6 px-4 text-center justify-center">
                    <BlurImage
                        width={208}
                        height={280}
