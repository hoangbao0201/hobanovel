        ...
        <>
            ...
            <>
                <div>
                            ...
                            <div className="relative">
                                <div className="flex w-full">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        />
                                        <div className="absolute transition-all w-10 h-10 flex items-center justify-center top-0 right-0">
                                            {valueInputSearch !== "" &&
                                                (!isLoadingSearch ? (
                                                    <button
                                                        onClick={() => {
                    ...
                    <ul className="flex">
                        {bannersMobile &&
                            listBannersMobile.map((itemBanner) => {
                                return (
                                    <li key={itemBanner.bannersId} className="border-b pb-3">
                                        <div
                    ...
                    <ul className="mt-5 grid grid-cols-2 gap-6">
                        {banners &&
